...
```
The mean of the total number of steps is **`r mean`** and the median **`r median`**.
...
The interval **`r max_int`** contains the maximum number of steps on average. It corresponds to 8:35h.
...
The dataset contains **`r NAs`** missing values.
...
```
The mean of the total number of steps is **`r mean_imp`** and the median **`r median_imp`** compared to **`r mean`** and  **`r median`** before imputation. The values increased after imputation.
